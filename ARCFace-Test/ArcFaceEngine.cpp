...
ArcFaceEngine::ArcFaceEngine(string configPath)
{
...
MRESULT ArcFaceEngine::PreDetectFaces(IplImage* image, ASF_MultiFaceInfo& faceRect, bool isRGB)
{
	if (!image)
	{
		return -1;
	...
	memcpy(&faceRect, &detectedFaces, sizeof(detectedFaces));
